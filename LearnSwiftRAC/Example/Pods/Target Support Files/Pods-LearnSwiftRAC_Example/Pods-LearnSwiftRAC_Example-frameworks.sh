...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${PODS_ROOT}/../../HWMMREngine.framework"
  install_framework "${PODS_ROOT}/../../HWMUISDK.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/LearnSwiftRAC/LearnSwiftRAC.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/Moya/Moya.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/PomeloNet/PomeloNet.framework"
